...
import { ArrowRight, Star, Clock, MapPin, Phone, Coffee, Zap, Users } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn delay={700} duration={800}>
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed text-pretty">
              Votre bar de quartier où se retrouver pour boire un verre, grignoter et passer un bon moment dans une
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-foreground mb-4">Pourquoi Le Grec Man ?</h2>
            ...
            {[
              {
                ...
                description: "Large sélection de boissons chaudes et fraîches pour tous les goûts",
              },
              {
                icon: Zap,
                title: "Service Rapide",
                description: "Commande et service optimisés pour ne pas vous faire attendre",
              },
              {
                icon: Users,
                title: "Ambiance Détendue",
                description: "Un cadre simple et chaleureux pour se retrouver entre amis",
              },
            ].map((feature, index) => (
              <Card
                key={index}
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-foreground mb-4">Nos Boissons Populaires</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Découvrez nos boissons les plus appréciées
            </p>
          </FadeIn>

          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12" staggerDelay={200}>
            {[
              {
                name: "Jus d'Orange Frais",
                description: "Pressé minute, 100% naturel",
                price: "800 FCFA",
                popular: true,
              },
              {
                name: "Café Expresso",
                description: "Café italien, servi chaud",
                price: "600 FCFA",
                popular: true,
              },
              {
                name: "Thé Glacé Maison",
                description: "Thé noir infusé, citron, menthe fraîche",
                price: "700 FCFA",
                popular: true,
              },
            ].map((drink, index) => (
              <Card
                key={index}
                className="group bg-card border-border hover:border-primary/30 transition-all duration-300 hover:shadow-lg"
              >
                <CardContent className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-lg font-semibold text-primary">{drink.price}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-foreground mb-6">Venez nous voir !</h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Que ce soit pour boire un verre, grignoter ou simplement passer du temps, vous êtes les bienvenus.
            </p>
          </FadeIn>

          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12" staggerDelay={100}>
            {[
              { icon: Clock, text: "Ouvert 7j/7 • 8h-22h" },
              { icon: MapPin, text: "Quartier Bastos, Yaoundé" },
